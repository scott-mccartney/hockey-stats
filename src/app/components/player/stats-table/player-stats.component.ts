...
export class PlayerStatsComponent implements OnInit {
  ...
  displayedColumns = ['id', 'userName', 'progress', 'color'];
  ...
  ngOnInit() {
    // this.dataSource = new StatDataSource(this.dataChange);
...
//   constructor(private dataChange: BehaviorSubject<PlayerSeason[]>) {
//     super();
//   }
